let observableDefer,observableInterval,Observable,distinctUntilChanged,map,startWith,log,isNode;_511‍.x([["default",()=>onHeightWidthChange]]);_511‍.w("rxjs",[["defer",["observableDefer"],function(v){observableDefer=v}],["interval",["observableInterval"],function(v){observableInterval=v}],["Observable",["Observable"],function(v){Observable=v}]]);_511‍.w("rxjs/operators",[["distinctUntilChanged",["distinctUntilChanged"],function(v){distinctUntilChanged=v}],["map",["map"],function(v){map=v}],["startWith",["startWith"],function(v){startWith=v}]]);_511‍.w("../log",[["default",["log"],function(v){log=v}]]);_511‍.w("./is_node",[["default",["isNode"],function(v){isNode=v}]]);/**
