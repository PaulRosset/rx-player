let log,areArraysOfNumbersEqual,be4toi,concat,PSSH_TO_INTEGER;_821‍.x([["default",()=>getInitData]]);_821‍.w("../../log",[["default",["log"],function(v){log=v}]]);_821‍.w("../../utils/are_arrays_of_numbers_equal",[["default",["areArraysOfNumbersEqual"],function(v){areArraysOfNumbersEqual=v}]]);_821‍.w("../../utils/byte_parsing",[["be4toi",["be4toi"],function(v){be4toi=v}],["concat",["concat"],function(v){concat=v}]]);_821‍.w("./constants",[["PSSH_TO_INTEGER",["PSSH_TO_INTEGER"],function(v){PSSH_TO_INTEGER=v}]]);/**
