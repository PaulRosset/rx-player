let observableDefer,observableInterval,Observable,distinctUntilChanged,map,startWith,log,isNode;_e33‍.x([["default",()=>onHeightWidthChange]]);_e33‍.w("rxjs",[["defer",["observableDefer"],function(v){observableDefer=v}],["interval",["observableInterval"],function(v){observableInterval=v}],["Observable",["Observable"],function(v){Observable=v}]]);_e33‍.w("rxjs/operators",[["distinctUntilChanged",["distinctUntilChanged"],function(v){distinctUntilChanged=v}],["map",["map"],function(v){map=v}],["startWith",["startWith"],function(v){startWith=v}]]);_e33‍.w("../log",[["default",["log"],function(v){log=v}]]);_e33‍.w("./is_node",[["default",["isNode"],function(v){isNode=v}]]);/**
