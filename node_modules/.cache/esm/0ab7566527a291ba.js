let assert,be2toi,be3toi,be4toi,be8toi,concat,itobe4,itobe8,hexToBytes,MAX_32_BIT_INT,createBox,getPlayReadyKIDFromPrivateData,getBoxContent,getBoxOffsets,getMDIA,getTRAF;_27a‍.x([["getMDHDTimescale",()=>getMDHDTimescale],["getPlayReadyKIDFromPrivateData",()=>getPlayReadyKIDFromPrivateData],["getTrackFragmentDecodeTime",()=>getTrackFragmentDecodeTime],["getDurationFromTrun",()=>getDurationFromTrun],["getSegmentsFromSidx",()=>getSegmentsFromSidx],["patchPssh",()=>patchPssh],["updateBoxLength",()=>updateBoxLength]]);_27a‍.w("../../../utils/assert",[["default",["assert"],function(v){assert=v}]]);_27a‍.w("../../../utils/byte_parsing",[["be2toi",["be2toi"],function(v){be2toi=v}],["be3toi",["be3toi"],function(v){be3toi=v}],["be4toi",["be4toi"],function(v){be4toi=v}],["be8toi",["be8toi"],function(v){be8toi=v}],["concat",["concat"],function(v){concat=v}],["itobe4",["itobe4"],function(v){itobe4=v}],["itobe8",["itobe8"],function(v){itobe8=v}]]);_27a‍.w("../../../utils/string_parsing",[["hexToBytes",["hexToBytes"],function(v){hexToBytes=v}]]);_27a‍.w("./constants",[["MAX_32_BIT_INT",["MAX_32_BIT_INT"],function(v){MAX_32_BIT_INT=v}]]);_27a‍.w("./create_box",[["createBox",["createBox"],function(v){createBox=v}]]);_27a‍.w("./drm",[["getPlayReadyKIDFromPrivateData",["getPlayReadyKIDFromPrivateData"],function(v){getPlayReadyKIDFromPrivateData=v}]]);_27a‍.w("./get_box",[["getBoxContent",["getBoxContent"],function(v){getBoxContent=v}],["getBoxOffsets",["getBoxOffsets"],function(v){getBoxOffsets=v}]]);_27a‍.w("./read",[["getMDIA",["getMDIA"],function(v){getMDIA=v}],["getTRAF",["getTRAF"],function(v){getTRAF=v}]]);/**
