let observableCombineLatest,observableDefer,observableFromEvent,observableInterval,observableMerge,NEVER,observableOf,delay,distinctUntilChanged,map,mapTo,startWith,switchMap,throttleTime,config,log,isNonEmptyString,HTMLElement_,isNode,shouldFavourCustomSafariEME;_821‍.x([["isActive",()=>isActive],["isVideoVisible",()=>isVideoVisible],["videoWidth$",()=>videoWidth$],["onPlayPause$",()=>onPlayPause$],["onTextTrackChanges$",()=>onTextTrackChanges$],["onLoadedMetadata$",()=>onLoadedMetadata$],["onSeeking$",()=>onSeeking$],["onSeeked$",()=>onSeeked$],["onEnded$",()=>onEnded$],["onTimeUpdate$",()=>onTimeUpdate$],["onFullscreenChange$",()=>onFullscreenChange$],["onSourceOpen$",()=>onSourceOpen$],["onUpdate$",()=>onUpdate$],["onRemoveSourceBuffers$",()=>onRemoveSourceBuffers$],["onEncrypted$",()=>onEncrypted$],["onKeyMessage$",()=>onKeyMessage$],["onKeyAdded$",()=>onKeyAdded$],["onKeyError$",()=>onKeyError$],["onKeyStatusesChange$",()=>onKeyStatusesChange$],["onPictureInPictureEvent$",()=>onPictureInPictureEvent$]]);_821‍.w("rxjs",[["combineLatest",["observableCombineLatest"],function(v){observableCombineLatest=v}],["defer",["observableDefer"],function(v){observableDefer=v}],["fromEvent",["observableFromEvent"],function(v){observableFromEvent=v}],["interval",["observableInterval"],function(v){observableInterval=v}],["merge",["observableMerge"],function(v){observableMerge=v}],["NEVER",["NEVER"],function(v){NEVER=v}],["of",["observableOf"],function(v){observableOf=v}]]);_821‍.w("rxjs/operators",[["delay",["delay"],function(v){delay=v}],["distinctUntilChanged",["distinctUntilChanged"],function(v){distinctUntilChanged=v}],["map",["map"],function(v){map=v}],["mapTo",["mapTo"],function(v){mapTo=v}],["startWith",["startWith"],function(v){startWith=v}],["switchMap",["switchMap"],function(v){switchMap=v}],["throttleTime",["throttleTime"],function(v){throttleTime=v}]]);_821‍.w("../config",[["default",["config"],function(v){config=v}]]);_821‍.w("../log",[["default",["log"],function(v){log=v}]]);_821‍.w("../utils/is_non_empty_string",[["default",["isNonEmptyString"],function(v){isNonEmptyString=v}]]);_821‍.w("./browser_compatibility_types",[["HTMLElement_",["HTMLElement_"],function(v){HTMLElement_=v}]]);_821‍.w("./is_node",[["default",["isNode"],function(v){isNode=v}]]);_821‍.w("./should_favour_custom_safari_EME",[["default",["shouldFavourCustomSafariEME"],function(v){shouldFavourCustomSafariEME=v}]]);/**
