let assert,be2toi,be3toi,be4toi,be8toi,concat,itobe4,itobe8,hexToBytes,MAX_32_BIT_INT,createBox,getPlayReadyKIDFromPrivateData,getBoxContent,getBoxOffsets,getMDIA,getTRAF;_621‍.x([["getMDHDTimescale",()=>getMDHDTimescale],["getPlayReadyKIDFromPrivateData",()=>getPlayReadyKIDFromPrivateData],["getTrackFragmentDecodeTime",()=>getTrackFragmentDecodeTime],["getDurationFromTrun",()=>getDurationFromTrun],["getSegmentsFromSidx",()=>getSegmentsFromSidx],["patchPssh",()=>patchPssh],["updateBoxLength",()=>updateBoxLength]]);_621‍.w("../../../utils/assert",[["default",["assert"],function(v){assert=v}]]);_621‍.w("../../../utils/byte_parsing",[["be2toi",["be2toi"],function(v){be2toi=v}],["be3toi",["be3toi"],function(v){be3toi=v}],["be4toi",["be4toi"],function(v){be4toi=v}],["be8toi",["be8toi"],function(v){be8toi=v}],["concat",["concat"],function(v){concat=v}],["itobe4",["itobe4"],function(v){itobe4=v}],["itobe8",["itobe8"],function(v){itobe8=v}]]);_621‍.w("../../../utils/string_parsing",[["hexToBytes",["hexToBytes"],function(v){hexToBytes=v}]]);_621‍.w("./constants",[["MAX_32_BIT_INT",["MAX_32_BIT_INT"],function(v){MAX_32_BIT_INT=v}]]);_621‍.w("./create_box",[["createBox",["createBox"],function(v){createBox=v}]]);_621‍.w("./drm",[["getPlayReadyKIDFromPrivateData",["getPlayReadyKIDFromPrivateData"],function(v){getPlayReadyKIDFromPrivateData=v}]]);_621‍.w("./get_box",[["getBoxContent",["getBoxContent"],function(v){getBoxContent=v}],["getBoxOffsets",["getBoxOffsets"],function(v){getBoxOffsets=v}]]);_621‍.w("./read",[["getMDIA",["getMDIA"],function(v){getMDIA=v}],["getTRAF",["getTRAF"],function(v){getTRAF=v}]]);/**
