let observableDefer,log,getNextBoxOffsets,be4toi,concat,castToObservable,PSSH_TO_INTEGER;_b54‍.x([["patchInitData",()=>patchInitData],["default",()=>generateKeyRequest]]);_b54‍.w("rxjs",[["defer",["observableDefer"],function(v){observableDefer=v}]]);_b54‍.w("../../log",[["default",["log"],function(v){log=v}]]);_b54‍.w("../../parsers/containers/isobmff",[["getNextBoxOffsets",["getNextBoxOffsets"],function(v){getNextBoxOffsets=v}]]);_b54‍.w("../../utils/byte_parsing",[["be4toi",["be4toi"],function(v){be4toi=v}],["concat",["concat"],function(v){concat=v}]]);_b54‍.w("../../utils/cast_to_observable",[["default",["castToObservable"],function(v){castToObservable=v}]]);_b54‍.w("./constants",[["PSSH_TO_INTEGER",["PSSH_TO_INTEGER"],function(v){PSSH_TO_INTEGER=v}]]);/**
