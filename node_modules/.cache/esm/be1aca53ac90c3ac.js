let observableDefer,observableOf,observableThrow,castToObservable,MediaKeys_,isIE11,isNode,shouldFavourCustomSafariEME,CustomMediaKeySystemAccess,getIE11MediaKeysCallbacks,MSMediaKeysConstructor,getOldKitWebKitMediaKeyCallbacks,isOldWebkitMediaElement,getWebKitMediaKeysCallbacks,WebKitMediaKeysConstructor;_ac9‍.x([["requestMediaKeySystemAccess",()=>requestMediaKeySystemAccess],["setMediaKeys",()=>setMediaKeys]]);_ac9‍.w("rxjs",[["defer",["observableDefer"],function(v){observableDefer=v}],["of",["observableOf"],function(v){observableOf=v}],["throwError",["observableThrow"],function(v){observableThrow=v}]]);_ac9‍.w("../../../utils/cast_to_observable",[["default",["castToObservable"],function(v){castToObservable=v}]]);_ac9‍.w("../../browser_compatibility_types",[["MediaKeys_",["MediaKeys_"],function(v){MediaKeys_=v}]]);_ac9‍.w("../../browser_detection",[["isIE11",["isIE11"],function(v){isIE11=v}]]);_ac9‍.w("../../is_node",[["default",["isNode"],function(v){isNode=v}]]);_ac9‍.w("../../should_favour_custom_safari_EME",[["default",["shouldFavourCustomSafariEME"],function(v){shouldFavourCustomSafariEME=v}]]);_ac9‍.w("./../custom_key_system_access",[["default",["CustomMediaKeySystemAccess"],function(v){CustomMediaKeySystemAccess=v}]]);_ac9‍.w("./ie11_media_keys",[["default",["getIE11MediaKeysCallbacks"],function(v){getIE11MediaKeysCallbacks=v}],["MSMediaKeysConstructor",["MSMediaKeysConstructor"],function(v){MSMediaKeysConstructor=v}]]);_ac9‍.w("./old_webkit_media_keys",[["default",["getOldKitWebKitMediaKeyCallbacks"],function(v){getOldKitWebKitMediaKeyCallbacks=v}],["isOldWebkitMediaElement",["isOldWebkitMediaElement"],function(v){isOldWebkitMediaElement=v}]]);_ac9‍.w("./webkit_media_keys",[["default",["getWebKitMediaKeysCallbacks"],function(v){getWebKitMediaKeysCallbacks=v}]]);_ac9‍.w("./webkit_media_keys_constructor",[["WebKitMediaKeysConstructor",["WebKitMediaKeysConstructor"],function(v){WebKitMediaKeysConstructor=v}]]);/**
