...
var _spacer = _interopRequireDefault(require("comment-parser/lib/parser/spacer"));

var _specParser = require("comment-parser/lib/parser/spec-parser");
...
const getTokenizers = () => {
  // trim
  return [// Tag
  (0, _specParser.tagTokenizer)(), // Type
  spec => {
    if (['default', 'defaultvalue', 'see'].includes(spec.tag)) {
      return spec;
    }

    return (0, _specParser.typeTokenizer)()(spec);
  }, // Name
  spec => {
    ...
    return (0, _specParser.nameTokenizer)()(spec);
  }, // Description
  spec => {
    return (0, _specParser.descriptionTokenizer)((0, _spacer.default)('preserve'))(spec);
  }];
};
/**
 *
