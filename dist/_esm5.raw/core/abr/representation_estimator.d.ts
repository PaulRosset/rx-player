 ...
 * etc.) and Period.
 */
export declare type IABRBufferEvents = IABRAddedSegmentEvent | IABRMetricsEvent | IABRRepresentationChangeEvent | IABRRequestBeginEvent | IABRRequestProgressEvent | IABRRequestEndEvent;
