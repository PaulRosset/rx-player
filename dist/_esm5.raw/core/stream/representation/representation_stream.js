...
export default function RepresentationStream(_a) {
    ...
    var status$ = observableCombineLatest([
        ...
        var _b = _a[0], timing = _b[0], bufferGoal = _b[1], terminate = _b[2];
        ...
        if (!representation.index.isInitialized()) {
            ...
            if (initSegment !== null && initSegmentObject === null) {
                ...
                var initSegmentPriority = 0;
                neededSegments = __spreadArrays([
        ...
        if (neededSegments.length > 0 || period.end == null) {
            ...
            if (lastPosition === undefined) {
                ...
                var endOfRange = period.end != null
        ...
        if (mostNeededSegment == null) {
            ...
            return observableConcat(observableOf.apply(void 0, neededActions), status.isFull ? observableOf(EVENTS.fullStream(bufferType)) : EMPTY);
        }
        if (currentSegmentRequest === null) {
     ...
     */
    var streamQueue$ = startDownloadingQueue$.pipe(switchMap(function () {
        return downloadQueue.length > 0 ? loadSegmentsFromQueue() : EMPTY;
    ...
    function loadSegmentsFromQueue() {
        var requestNextSegment$ = observableDefer(function () {
            ...
            return request$.pipe(mergeMap(function (evt) {
                switch (evt.type) {
                    case "warning":
                        return observableOf({
                            type: "retry",
