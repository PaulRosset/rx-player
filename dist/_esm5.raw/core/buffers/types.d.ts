...
export declare type IRepresentationBufferEvent<T> = IBufferEventAddedSegment<T> | IProtectedSegmentEvent | IBufferStateFull | IBufferStateActive | IBufferManifestMightBeOutOfSync | IBufferNeedsDiscontinuitySeek | IBufferNeedsManifestRefresh | IBufferWarningEvent;
